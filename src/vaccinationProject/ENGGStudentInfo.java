...
public class ENGGStudentInfo {
    ENGGStudentInfo() throws FileNotFoundException {
        ...
        try {
            File file = new File("C:/-COVID19--Vaccination---Project/DataEntryList/ENG Students Info.txt");
