...
public class PhStudentInfo extends VaccinationDate {
    PhStudentInfo() throws FileNotFoundException {

        VaccinationDate vaccinationDate = new VaccinationDate();
        System.out.println("\nData Input to Public Health Department Students-");
        int a = 0;
        String name, department,section;
        int id, batch;
        try {
            Formatter formatter2 = new Formatter("C:/-COVID19--Vaccination---Project/DataEntryList/PH Students Info.txt");
        ...
        try {
            File file = new File("C:/-COVID19--Vaccination---Project/DataEntryList/PH Students Info.txt");
            ...
            while (scanner.hasNext()) {
                ...
                System.out.println();
                System.out.println("*********************************************************");
                System.out.println("Vaccine Application Card For PH Department-");
