...
public class BanStudentInfo extends VaccinationDate {
    BanStudentInfo() throws FileNotFoundException {
        ...
        int id, batch;
        try {
            Formatter formatter2 = new Formatter("C:/-COVID19--Vaccination---Project/DataEntryList/Bangla Students Info.txt");
        ...
        try {
            File file = new File("C:/-COVID19--Vaccination---Project/DataEntryList/Bangla Students Info.txt");
